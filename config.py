...
''', # 30
    ['🤖 ChatGPT 3.5 Turbo генерирует ответ...', #0
     '🤖 ChatGPT 3.5 Turbo переводит...',#1
     '⛔ Режим общего GPT отключен.\nПопросите администратора включить эту функцию командой `!gpt +allgpt`',#2
     '✅ Режим "allgpt" включен\nВыключить: `!gpt -allgpt`',#3
     '✅ Режим "allgpt" выключен\nВключить: `!gpt +allgpt`',#4
     '🖌️ DALL-E генерирует картинку...',#5
     '⛔ Режим общего DALL-E отключен.\nПопросите администратора включить эту функцию командой `!draw +alldraw`',#6
     '✅ Режим "alldraw" включен\nВыключить: `!draw -alldraw`',#7
     '✅ Режим "alldraw" выключен\nВключить: `!draw +alldraw`'#8
     ] #31
]
en = [
